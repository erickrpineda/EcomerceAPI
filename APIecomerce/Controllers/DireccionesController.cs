    ...
    public class DireccionesController : BaseAPIController
    {
        ...
        public HttpResponseMessage ObtenerTodos()
        {
            try
            {
                ...
                {
                    var x = DireccionesRepositorio.ObtenerTodos();
                    return OkResponse(x);
                }
                else
                {
        ...
        [ActionName("Guardar")]
        public HttpResponseMessage Guardar([FromBody] M_Direcciones c)
        {
            try
            {
                if (ValidarAutorizacion())
                {
                    ...
                    var x = DireccionesRepositorio.Guardar(c);
        ...
        public HttpResponseMessage ObtenerxID([FromUri] int id)
        {
            try
            {
                ...
                if (ValidarAutorizacion())
                {
                    var x = DireccionesRepositorio.ObtenerxId(id);
        ...
        public HttpResponseMessage Actualizar([FromBody] M_Direcciones a)
        {
            try
            {
                ...
                if (ValidarAutorizacion())
                {
                    var x = DireccionesRepositorio.Actualizar(a);
